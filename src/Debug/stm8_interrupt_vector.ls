  ...
  45                     ; 30 @far @interrupt void NonHandledInterrupt (void)
  45                     ; 31 {
  46                     	switch	.text
 ...
 120  003d 00            	dc.b	page(_TIM2_UPD_OVF_IRQHandler)
 121  003e 0000          	dc.w	_TIM2_UPD_OVF_IRQHandler
 ...
 148  0059 00            	dc.b	page(_UART_TX_IRQHandler)
 149  005a 0000          	dc.w	_UART_TX_IRQHandler
 150  005c 82            	dc.b	130
 152  005d 00            	dc.b	page(_UART_RX_IRQHandler)
 153  005e 0000          	dc.w	_UART_RX_IRQHandler
